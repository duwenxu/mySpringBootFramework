package com.example.SpringBoot.KotlinTest

import com.example.SpringBoot.Entity.ConfigIDEABean
import com.example.SpringBoot.Entity.TestEntitr
import com.example.SpringBoot.KotlinTest.TimeUtils.Companion.Y_S_CLOSE
import com.example.SpringBoot.KotlinTest.TimeUtils.Companion.Y_S_NORMAL
...
//    }
    ...
    var list1 = mutableListOf<Int>(1, 2, 5, 8, 4, 7)
    //不可变转可变
