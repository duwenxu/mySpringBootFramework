...
public class DogStatus
{
	...
	static String dir="F:\\display\\src\\main\\kotlin\\com\\waytogalaxy\\display\\superdog\\dlls\\";
	private static String assemble(String name){
		return dir+"dlls/"+name;
	}

	public static String runtime_library_x86_windows = assemble("dog_windows_3156389.dll");
	public static String runtime_library_x64_windows = assemble("dog_windows_x64_3156389.dll");

	public static String runtime_library_x86_linux = assemble("dog_windows_3156389.so");
	public static String runtime_library_x64_linux = assemble("dog_windows_x64_3156389.so");
	...
	public static void Init()
	{
		...
		try
		{
			...
			if (operatingSystem.indexOf("Windows") != -1)
			{
				...
				{
					System.load(runtime_library_x86_windows);
				}
				else if (architecture.equals("x86_64") || architecture.equals("amd64"))
				{
					System.load(runtime_library_x64_windows);
				}
				else
				{
					System.load(runtime_library_x86_windows);
			...
			else
			{
				...
				if (operatingSystem.indexOf("Linux") != -1)
				{
					if (architecture.equals("x86"))
					{
						System.load(runtime_library_x86_linux);
					}
					else if(architecture.equals("x86_64") || architecture.equals("amd64"))
					{
						System.load(runtime_library_x64_linux);
					}
					else
					{
						System.load(runtime_library_x86_linux);
